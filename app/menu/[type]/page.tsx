  ...
  return (
    <div className="min-h-screen bg-[#031f4a] text-white overflow-x-hidden relative">
      ...
      <nav className="sticky top-0 z-40 bg-[#031f4a]/80 backdrop-blur-2xl border-b border-white/[0.08]">
        <div ref={navRef} className="flex justify-start gap-2 px-4 py-2.5 overflow-x-auto overscroll-x-contain scrollbar-hide max-w-full touch-pan-x touch-pinch-zoom">
          {isVinosRoute
